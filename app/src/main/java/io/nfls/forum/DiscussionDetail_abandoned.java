...
public class DiscussionDetail_abandoned extends AppCompatActivity{
                        ...
                        if (comment[i]!=null) {
                            if (commentUSERID[i].equals(participantsID[j])) {
                                ...
                                if (comment[i].equals("discussionStickied")) {
                                    flag=flag*-1;
                                    if(flag==1) {
                                        list.add(participants[j]+" stickied the discussion.");
                                        System.out.println(participants[j]+" stickied the discussion.");
                                    }else{
                                        list.add(participants[j]+" unstickied the discussion.");
                                        System.out.println(participants[j]+" unstickied the discussion.");
                                    }
                                    ...
                                    list.add(String.valueOf(Html.fromHtml(html, imageGetter, new SizeLabel(20))));
